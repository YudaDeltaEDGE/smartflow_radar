...
def jalankan_step_B_roi(ctx: Context) -> Context:
    ...
    body_dir = base_dir / "Body"  # untuk total_buy_lot_5mnt debug
    ...
    tiles_out, harga_items, footer_items, buy5_items = svc.potong_24_tile_to_items(
        ...
        body_dir=body_dir if (cfg.debug_save and cfg.debug_save_total_buy_lot_5mnt_crop) else None,
        out_ext=cfg.ext,
    )
